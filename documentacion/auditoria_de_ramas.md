...
* **`feature/screaming-architecture` (`ee5f4ae`)**: Reorganización estructural de carpetas del frontend a un formato *feature-first* (Screaming Architecture) y habilitación de CORS para permitir despliegues desacoplados o unificados en Render.
...
* **`feature/render-deployment`**: Configuración de `render.yaml`, `Dockerfile` y variables de entorno para el despliegue de backend y frontend en Render.
